...
function floral_notice() {
	...
	<div class="updated notice notice-success is-dismissible">
		<p>
			...
			echo wp_kses_post( sprintf( __( 'Welcome! Thank you for choosing Floral Lite. To get started, visit our <a href="%s">welcome page</a>.', 'floral-lite' ), esc_url( admin_url( 'themes.php?page=floral-lite' ) ) ) );
			?>
		</p>
		<p>
			<a class="button" href="<?php echo esc_url( admin_url( 'themes.php?page=floral-lite' ) ); ?>"><?php esc_html_e( 'Get started with Floral', 'floral-lite' ); ?></a>
		</p>
	</div>
	<?php
	}
